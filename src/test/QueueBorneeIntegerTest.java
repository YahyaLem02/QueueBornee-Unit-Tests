...
import src.QueueBorneeInteger;

public class QueueBorneeIntegerTest {

    private QueueBorneeInteger queueVide;
    private QueueBorneeInteger queueCapaciteZero;
    private QueueBorneeInteger queueNormale;

    @Before
    public void setUp() {
        queueVide = new QueueBorneeInteger(3);
        queueCapaciteZero = new QueueBorneeInteger(0);
        queueNormale = new QueueBorneeInteger(3);
    ...
    public void testSupprimeElementDansQueueAvecUnElement() {
        QueueBorneeInteger queueUnElement = new QueueBorneeInteger(3);
